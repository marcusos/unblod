 ...
 * @generated
 */
public class SClassImpl extends MinimalEObjectImpl.Container implements SClass {
	/**
	 ...
	 * @ordered
	 */
	protected EList<SProperty> properties;
	...
	protected EClass eStaticClass() {
		return DatasetPackage.Literals.SCLASS;
	}
	 ...
	 * @generated
	 */
	public EList<SProperty> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<SProperty>(SProperty.class, this, DatasetPackage.SCLASS__PROPERTIES);
		}
		return properties;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatasetPackage.SCLASS__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DatasetPackage.SCLASS__PROPERTIES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case DatasetPackage.SCLASS__PROPERTIES:
				getProperties().clear();
				getProperties().addAll((Collection<? extends SProperty>)newValue);
				return;
			case DatasetPackage.SCLASS__NAME:
